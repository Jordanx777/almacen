...
class UsuarioModel {
    ...
    public function create(array $data): ?int {
        try {
            $sql = "INSERT INTO usuario (nombre, apellido, correo, contrasena, telefono, id_rol, activo, verificado) 
                    VALUES (:nombre, :apellido, :correo, :contrasena, :telefono, :id_rol, :activo, :verificado) 
