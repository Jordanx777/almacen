...
import {
  PortalModule
} from "./chunk-WDMTKBIW.js";
import {
  PlatformModule
} from "./chunk-3LOVMXBG.js";
import {
...
} from "./chunk-Z3HSZS6E.js";
import {
  Platform
} from "./chunk-EXKBCPV4.js";
import {
  CommonModule,
  DOCUMENT,
  NgIf,
...
var SmoothScrollManager = class {
  ...
  _applyScrollToOptions(el, options) {
    ...
    const context = {
      ...
      easing: (0, import_bezier_easing.default)(options.easing.x1, options.easing.y1, options.easing.x2, options.easing.y2)
    };
...
SmoothScrollManager.ɵfac = function SmoothScrollManager_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SmoothScrollManager)(ɵɵinject(DOCUMENT), ɵɵinject(PLATFORM_ID), ɵɵinject(SMOOTH_SCROLL_OPTIONS, 8));
};
...
SmoothScroll.ɵfac = function SmoothScroll_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SmoothScroll)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(SmoothScrollManager));
};
SmoothScroll.ɵdir = ɵɵdefineDirective({
  type: SmoothScroll,
...
SmoothScrollModule.ɵmod = ɵɵdefineNgModule({
  type: SmoothScrollModule,
  declarations: [SmoothScroll],
  exports: [SmoothScroll]
});
SmoothScrollModule.ɵinj = ɵɵdefineInjector({});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SmoothScrollModule, [{
    type: NgModule,
    args: [{
      declarations: [SmoothScroll],
      exports: [SmoothScroll]
...
ScrollViewport.ɵfac = function ScrollViewport_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ScrollViewport)(ɵɵdirectiveInject(ElementRef));
};
ScrollViewport.ɵdir = ɵɵdefineDirective({
  type: ScrollViewport,
...
ScrollbarManager.ɵfac = function ScrollbarManager_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ScrollbarManager)(ɵɵinject(NG_SCROLLBAR_OPTIONS, 8));
};
...
var NativeScrollbarSizeFactory = class {
...
NativeScrollbarSizeFactory.ɵfac = function NativeScrollbarSizeFactory_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NativeScrollbarSizeFactory)(ɵɵinject(DOCUMENT), ɵɵinject(ScrollbarManager), ɵɵinject(Platform));
};
...
HideNativeScrollbar.ɵfac = function HideNativeScrollbar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || HideNativeScrollbar)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NativeScrollbarSizeFactory));
};
HideNativeScrollbar.ɵdir = ɵɵdefineDirective({
...
NgAttr.ɵfac = function NgAttr_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgAttr)(ɵɵdirectiveInject(ElementRef));
};
NgAttr.ɵdir = ɵɵdefineDirective({
  type: NgAttr,
  selectors: [["", "ngAttr", ""]],
  inputs: {
    ngAttr: "ngAttr"
...
ResizeSensor.ɵfac = function ResizeSensor_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ResizeSensor)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(NgScrollbarBase));
};
ResizeSensor.ɵdir = ɵɵdefineDirective({
  type: ResizeSensor,
...
TrackAdapter.ɵfac = function TrackAdapter_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TrackAdapter)(ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(HTMLElement), ɵɵdirectiveInject(Document));
};
TrackAdapter.ɵdir = ɵɵdefineDirective({
  type: TrackAdapter,
  standalone: false
});
(() => {
...
var TrackXDirective = class extends TrackAdapter {
  get pageProperty() {
    return "pageX";
  }
  get offset() {
...
TrackXDirective.ɵfac = function TrackXDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TrackXDirective)(ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
};
TrackXDirective.ɵdir = ɵɵdefineDirective({
...
var TrackYDirective = class extends TrackAdapter {
  get pageProperty() {
    return "pageY";
  }
  get offset() {
...
TrackYDirective.ɵfac = function TrackYDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TrackYDirective)(ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
};
TrackYDirective.ɵdir = ɵɵdefineDirective({
...
var ThumbAdapter = class {
  ...
  dragged(event) {
    ...
    return dragStart.pipe(pluck(this.pageProperty), map((pageOffset) => pageOffset - this.dragStartOffset), mergeMap((mouseDownOffset) => dragging.pipe(
...
ThumbAdapter.ɵfac = function ThumbAdapter_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ThumbAdapter)(ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(TrackAdapter), ɵɵdirectiveInject(HTMLElement), ɵɵdirectiveInject(Document));
};
ThumbAdapter.ɵdir = ɵɵdefineDirective({
  type: ThumbAdapter,
  outputs: {
    dragging: "dragging"
  },
...
var ThumbXDirective = class extends ThumbAdapter {
  get clientProperty() {
    return "clientX";
  }
  get pageProperty() {
...
ThumbXDirective.ɵfac = function ThumbXDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ThumbXDirective)(ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(TrackXDirective), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(Directionality));
};
ThumbXDirective.ɵdir = ɵɵdefineDirective({
...
var ThumbYDirective = class extends ThumbAdapter {
  get pageProperty() {
    return "pageY";
  }
  get viewportScrollSize() {
...
ThumbYDirective.ɵfac = function ThumbYDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ThumbYDirective)(ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(TrackYDirective), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
};
ThumbYDirective.ɵdir = ɵɵdefineDirective({
...
Scrollbar.ɵfac = function Scrollbar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || Scrollbar)(ɵɵdirectiveInject(HTMLElement), ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(Document), ɵɵdirectiveInject(NgZone));
};
Scrollbar.ɵdir = ɵɵdefineDirective({
  type: Scrollbar,
  standalone: false
});
(() => {
...
var ScrollbarY = class extends Scrollbar {
  get viewportScrollSize() {
    return this.cmp.viewport.scrollHeight;
  }
  constructor(el, cmp, platform, document, zone) {
...
ScrollbarY.ɵfac = function ScrollbarY_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ScrollbarY)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(NgZone));
};
ScrollbarY.ɵcmp = ɵɵdefineComponent({
  type: ScrollbarY,
...
var ScrollbarX = class extends Scrollbar {
  get viewportScrollSize() {
    return this.cmp.viewport.scrollWidth;
  }
  constructor(el, cmp, platform, document, zone) {
...
ScrollbarX.ɵfac = function ScrollbarX_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ScrollbarX)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgScrollbarBase), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(NgZone));
};
ScrollbarX.ɵcmp = ɵɵdefineComponent({
  type: ScrollbarX,
...
NgScrollbar.ɵfac = function NgScrollbar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NgScrollbar)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Directionality), ɵɵdirectiveInject(SmoothScrollManager), ɵɵdirectiveInject(ScrollbarManager));
};
NgScrollbar.ɵcmp = ɵɵdefineComponent({
  type: NgScrollbar,
  ...
  dependencies: [NgIf, ScrollViewport, HideNativeScrollbar, NgAttr, ResizeSensor, ScrollbarY, ScrollbarX],
...
NgScrollbarModule.ɵmod = ɵɵdefineNgModule({
...
NgScrollbarModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule, BidiModule, PortalModule, PlatformModule, SmoothScrollModule]
});
(() => {
